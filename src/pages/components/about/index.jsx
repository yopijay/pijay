...
const Index = () => {
    return (
        <Stack direction= "column" justifyContent= "flex-start" alignItems= "stretch" spacing= { 3 }>
            <Typography sx= {{ fontWeight: 'bold', color: '#e4f7f8' }} variant= "h6">About Me</Typography>
            <Typography color= "#e4f7f8">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer eros diam, dignissim ac sem non, volutpat pulvinar elit. 
            ...
            <Typography color= "#e4f7f8">Duis maximus nisl vitae pulvinar iaculis. Nam odio eros, mollis at elit sagittis, feugiat dapibus turpis. 
